...
function OAuth(opts) {
	...
	switch(this.signature_method) {
		case 'HMAC-SHA1':
			this.hash = require('./sha1').b64_hmac_sha1;
			break;
		default:
			console.warn('oauth-1.0a support this hash right now.');
			break;
	}
}
...
OAuth.prototype.getSignature = function(request, token_secret, oauth_data) {
	return this.hash(this.getSigningKey(token_secret), this.getBaseString(request, oauth_data));
};
...
OAuth.prototype.getParameterString = function(request, oauth_data) {
	var base_string_data = this.sortData(this.percentEncodeData(this.mergeObject(oauth_data, this.mergeObject(request.data, this.deParam(request.url)))));
	...
	// return this.percentEncode(data_str);
	return data_str;
};
...
OAuth.prototype.toHeader = function(oauth_data) {
	oauth_data = this.sortData(oauth_data);
...
*/
OAuth.prototype.sortData = function(data) {
